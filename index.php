...
<head>
  ...
  <title> Reigel Gallarde - RootsFM demo </title>
  
  <script type='text/javascript' src='https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js'></script>
  <script type="text/javascript" src="http://code.jquery.com/ui/1.8.18/jquery-ui.min.js"></script>
  <script type='text/javascript' src="http://roots.fm/player/js/jquery.ui.touch-punch.min.js"></script>
  <script type='text/javascript' src="http://roots.fm/player/js/jquery.cookie.js"></script>    
  <script type='text/javascript' src="http://roots.fm/player/js/perfect-scrollbar.js"></script>
  <script type='text/javascript' src="http://roots.fm/player/js/jquery.rotate.js"></script>
  <script type='text/javascript' src="http://roots.fm/player/js/plate.js"></script>
  <script type='text/javascript' src="http://seowidget.net/plates/platefix.js"></script>
  <link rel="stylesheet" type="text/css" href="http://roots.fm/player/css/player.css">
...
<body>
  <noscript>Sorry, you need a browser which supports <a href="http://musicstorm.org/#nojs">JavaScript</a>
</noscript>
